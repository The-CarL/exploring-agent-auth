"""Pattern 8: Three-Legged OAuth (service side).

Same JWKS-based JWT validation as pattern 5. The token is indistinguishable
on the wire from patterns 5-7. The difference is how it was obtained: the
user explicitly consented via the browser, and the agent never saw the
user's password.
"""
